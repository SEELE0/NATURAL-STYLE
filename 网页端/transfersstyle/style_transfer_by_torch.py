...
class GramMatrix(torch.nn.Module):##格拉姆矩阵
...
class StyleTransfer:
    ...
    def deprocess_img(self, x, index):
        ...
        filename = result_folder + '.png'
        img.save('photo/photo_transfer/' + filename)
...
def main(content_file, style_file):
    content_file = content_file#'photo/photo_main/timg.png'
    style_file = style_file#'photo/photo_type/Scream.jpg'
